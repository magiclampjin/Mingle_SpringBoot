...
@Entity
@Table(name = "popular_post_with_rownum")
@Getter
@Setter
@NoArgsConstructor
@ToString
public class PopularPostView {
	...
	@Builder
	public PopularPostView(Long id, Long rownum, String memberId, String memberNickname, String title, String content,
