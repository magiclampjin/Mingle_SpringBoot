...
@Entity
@Table(name = "notice_post_with_rownum")
@Getter
@Setter
@NoArgsConstructor
@ToString
public class NoticePostView {
	...
	@Builder
	public NoticePostView(Long id, Long rownum, String memberId, String memberNickname, String title, String content,
